 ...
 *
 * @returns {addons: any, dataCloud: any, salesforce: any}
 */
...
/**
 * Parse a request from a Heroku-typed {@link https://help.salesforce.com/s/articleView?id=sf.external_services.htm&type=5 | External Service}.
 *
 * @property headers The request's headers
 * @property body The request's body
 * @property log A logger instance
 * @returns {InvocationEvent,Context,Logger} Object containing InvocationEvent,Context,Logger instances hydrated from the request
 */
export function parseRequest(
  ...
  const clientContext = JSON.parse(
    Buffer.from(encodedClientContext, "base64").toString("utf8")
  );
  ...
  return {
    ...
    context,
    logger: log || new LoggerImpl(context.id),
  };
}

/**
 * Parse a {@link https://help.salesforce.com/s/articleView?id=sf.c360_a_create_a_data_action_target_of_webhook_type.htm&type=5 | Data Action Target} request.
 *
 * @property body The request's body
...
/**
 * Represents a UnitOfWork.  The UnitOfWork API is a wrapper around Salesforce's {@link https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/resources_composite_graph.htm | Composite Graph API}.
 */
...
/**
 * Represents event schemas in a {@link https://help.salesforce.com/s/articleView?id=sf.c360_a_create_a_data_action_target_of_webhook_type.htm&type=5 | Data Action Target} request.
 */
...
/**
 * Represents a {@link https://developer.salesforce.com/docs/atlas.en-us.platform_events.meta/platform_events/sforce_api_objects_dataobjectdatachgevent.htm | DataObjectDataChgEvent}.
 */
...
/**
 * Represents a {@link https://help.salesforce.com/s/articleView?id=sf.c360_a_create_a_data_action_target_of_webhook_type.htm&type=5 | Data Action Target} request.
 */
...
/**
 * Represents a {@link https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_query_v2.htm | Data Cloud Query API} request.
 */
...
/**
 * Represents a {@link https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_query_v2.htm | Data Cloud Query API} response.
 */
...
/**
 * Represents a {@link https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_insert_records.htm | Insert Records API} response.
 */
...
export interface DataCloudApi {
  ...
  /**
   * {@link https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_get_query_v2.htm | Data Cloud Query Next Batch API}
   * @param nextBatchId
   */
  queryNextBatch(nextBatchId: string): Promise<DataCloudQueryResponse>;

  /**
   * {@link https://developer.salesforce.com/docs/atlas.en-us.c360a_api.meta/c360a_api/c360a_api_insert_records.htm | Insert Records API}
   * @param name
   * @param objectName
   * @param data
   */
